...
public class EvaluacionRestaurante extends AppCompatActivity implements RatingBar.OnRatingBarChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainImage.setImageResource(restaurante.getImagen());
        nombre.setText(restaurante.getNombre());
        descripcion.setText(restaurante.getDescripcion());
        direccion.setText(restaurante.getDireccionTelefono());
    }
